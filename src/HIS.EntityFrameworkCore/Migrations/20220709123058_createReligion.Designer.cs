...
namespace HIS.Migrations
{
    ...
    [Migration("20220709123058_createReligion")]
    partial class createReligion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HIS.AdministrativeGenders.AdministrativeGender", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AdministrativeGenders", "Lookup");
                });

            modelBuilder.Entity("HIS.AdministrativeSexes.AdministrativeSex", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AdministrativeSexes", "Lookup");
                });

            modelBuilder.Entity("HIS.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HIS.ContactModes.ContactMode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ContactModes", "Lookup");
                });

            modelBuilder.Entity("HIS.Countries.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HIS.Educations.Education", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Educations", "Lookup");
                });

            modelBuilder.Entity("HIS.Facilities.Facility", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Facilities", "Lookup");
                });

            modelBuilder.Entity("HIS.IdentifierTypes.IdentifierType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IdentifierTypes", "Lookup");
                });

            modelBuilder.Entity("HIS.InActiveReasons.InActiveReason", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InActiveReasons", "Lookup");
                });

            modelBuilder.Entity("HIS.Languages.Language", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Languages", "Lookup");
                });

            modelBuilder.Entity("HIS.MaritalStatuses.MaritalStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HIS.NamePrefixes.NamePrefix", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AdministrativeSexId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("NamePrefixes", "Lookup");
                });

            modelBuilder.Entity("HIS.Nationalities.Nationality", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HIS.Races.Race", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Races", "Lookup");
                });

            modelBuilder.Entity("HIS.Relationships.Relationship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Relationships", "Lookup");
                });

            modelBuilder.Entity("HIS.Religions.Religion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HIS.NamePrefixes.NamePrefix", b =>
                {
                    b.HasOne("HIS.AdministrativeSexes.AdministrativeSex", "AdministrativeSex")
                        .WithMany()

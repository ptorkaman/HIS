...
{
    public partial class LookUpTablesParttwo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumericIsoCode = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true),
                    Sequence = table.Column<int>(type: "integer", nullable: false),
                    IsDefaultIndicator = table.Column<bool>(type: "boolean", nullable: false),
                    IsSystemIndicator = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Comments = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    InActiveStatus = table.Column<int>(type: "integer", nullable: false),
                    Sequence = table.Column<int>(type: "integer", nullable: false),
                    IsDefaultIndicator = table.Column<bool>(type: "boolean", nullable: false),
                    IsSystemIndicator = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InActiveReasons", x => x.Id);
                });
